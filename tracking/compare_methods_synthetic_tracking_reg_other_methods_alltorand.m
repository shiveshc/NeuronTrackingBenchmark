...
%%%%
% function compare_methods_synthetic_tracking_reg_other_methods_alltorand(precision, recall, num)
% precision = [0.9];
% recall = [0.9];
% precision = 0.75;
% recall = 0.75;
...
param_p = [0.9,0.8,0.7,0.6];
param_r = [0.9,0.8,0.7,0.6];
...
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_CPD_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_CPD')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_GLMD_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GLMD')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_GLTP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GLTP')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_GMMReg_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GMMReg')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_TPSRPM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_TPSRPM')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_PRGLS_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_PRGLS')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_L2ERPM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_L2ERPM')
...
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_ECMPR_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_ECMPR')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_alltorand\results_munkres_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_munkres')

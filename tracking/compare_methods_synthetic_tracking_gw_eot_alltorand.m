...
function compare_methods_synthetic_tracking_gw_eot_alltorand(precision,recall,num)
...
%             results = [results;v,precision(1,p),recall(1,r),precision_param,recall_param,lambda_PA,lambda_LR,lambda_DV,lambda_angle,alpha,noise_level,curr_runtime,track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity];
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_gw_eot_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results')

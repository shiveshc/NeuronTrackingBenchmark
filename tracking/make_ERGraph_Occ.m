function [Graph1,Graph2] = make_ERGraph_Occ(data1,data2,nv1,nv2,p,k)
% make gph from Pts
% this will be used later by some methods as input for graph matching
%
% Input
%     data1           -   Pts in the data1 nv1 x 3
%     data2           -   Pts in the data1 nv2 x 3
%     nv1             -   number of points in data 1
%     nv2             -   number of points in data 2
%     p               -   edge probability
%     k               -   num nearest neighbors
%
% Output
%     Graph1      -   Pts in gph
%     Graph2      -   node incidence matrix (starting point) 2 x (2m)

% Originally written by Charu Sharma (ICML 2018)

...
function [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_cinda(base_track_gt, frame_track_gt, trajectories, ids)

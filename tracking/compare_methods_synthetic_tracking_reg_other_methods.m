...
% function compare_methods_synthetic_tracking_reg_other_methods(precision, recall, num)
% precision = [0.9];
% recall = [0.9];
% precision = 0.75;
% recall = 0.75;
...
%                 [tracks_munkres, munkres_runtime] = methods_munkres(source, target, i, tracks_munkres, munkres_runtime, 1);
            ...
            results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_CPD);
            results = add_var_to_struct(results,precision(1,p),recall(1,r),precision_param,recall_param,CPD_runtime);
            if isempty(fieldnames(results_CPD)); results_CPD = results; else; results_CPD = [results_CPD;results]; end
            
            results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_GLMD);
            ...
            results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_GLTP);
            ...
            results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_GMMReg);
            ...
            results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_TPSRPM);
...
%             results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_PRGLS);
...
%             
%             results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_L2ERPM);
...
%             
%             results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_MRRPM);
...
%             if isempty(fieldnames(results_MRRPM)); results_MRRPM = results; else; results_MRRPM = [results_MRRPM;results]; end
            ...
            results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_ECMPR);
            ...
            results = quantify_accuracy_sequential_v2(base_track_gt, frame_track_gt, tracks_munkres);
...
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_CPD);
...
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_GLMD);
...
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_GLTP);
...
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_GMMReg);
...
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_TPSRPM);
...
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_PRGLS);
...
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_L2ERPM);
...
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_ECMPR);
...
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_sequential(base_track_gt, frame_track_gt, tracks_munkres);
...
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_CPD_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_CPD')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_GLMD_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GLMD')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_GLTP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GLTP')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_GMMReg_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GMMReg')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_TPSRPM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_TPSRPM')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_PRGLS_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_PRGLS')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_L2ERPM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_L2ERPM')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_MRRPM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_MRRPM')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_ECMPR_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_ECMPR')
%         save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/reg_OM_sequential/results_munkres_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_munkres')

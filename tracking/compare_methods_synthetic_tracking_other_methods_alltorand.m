...
%%%%
function compare_methods_synthetic_tracking_other_methods_alltorand(precision, recall, num)
...
%             frame_to_match = base_track_gt;
            frame_to_match = frame_track_gt{1,randperm(size(frame_track_gt,2),1)};
            for i = 1:size(frame_track_gt,2)
                tic
                source = frame_to_match;
                source = source(:,2:4);
...
%             total_FGMD_runtime = common_runtime + F_t1 + FGMD_runtime;
            ...
            %% Leordeanu methods
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_SM);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_SM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_SM')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_SM_IPFP);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_SMIPFP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_SM_IPFP')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_IPFP_gm);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPgm_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFP_gm')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_IPFP);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFP')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_IPFP_MAP);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPmap_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFP_MAP')
            
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_L2QP_MAP);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_L2QPMAP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_L2QP_MAP')
            
            
            %% KerGM methods
%             results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_GNCCP);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_GNCCP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GNCCP')
%             
%             results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_BPFG);
...
%             save(['/gpfs/pace1/project/pchbe2/schaudhary9/OptimalTransport/Results/results_BPFG_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_BPFG')
            ...
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_PSM);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_PSM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_PSM')
            
            
            %% FGM methods
%             results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_GA);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_GA_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GA')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_PHM);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_PHM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_PHM')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_SMAC);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_SMAC_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_SMAC')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_IPFPU);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPU_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFPU')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_IPFPS);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPS_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFPS')
            
            results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_RRWM);
            ...
            save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_RRWM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_RRWM')
            
%             results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_FGMD);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_FGMD_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_FGMD')
            

            %% methods that require adjacency matrices
%             results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_EigenAlign);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_EigenAlign_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_EigenAlign')
%             
%             results = quantify_accuracy_alltoone_v2(base_track_gt, frame_track_gt, tracks_FAQAP);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_FAQAP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_FAQAP')


            %% Leordeanu methods
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_SM);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_SM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_SM')
% 
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_SM_IPFP);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_SMIPFP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_SM_IPFP')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_IPFP_gm);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPgm_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFP_gm')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_IPFP);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFP')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_IPFP_MAP);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPmap_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFP_MAP')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_L2QP_MAP);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_L2QPMAP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_L2QP_MAP')
            ...
            %% KerGM methods
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_GNCCP);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltoone/results_GNCCP_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GNCCP')
            
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_BPFG);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltoone/results_BPFG_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_BPFG')
            
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_PSM);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_PSM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_PSM')
            ...
            %% FGM methods
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_GA);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltoone/results_GA_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_GA')

%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_PHM);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_PHM_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_PHM')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_SMAC);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_SMAC_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_SMAC')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_IPFPU);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPU_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFPU')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_IPFPS);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltorand/results_IPFPS_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_IPFPS')
%             
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_RRWM);
...
%             [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_FGMD);
...
%             save(['/storage/coda1/p-hl94/0/schaudhary9/rich_project_pchbe2/OptimalTransport/Results/OM_alltoone/results_FGMD_',num2str(precision(1,p)),'_',num2str(recall(1,r)),'_',num2str(num),'.mat'],'results_FGMD')

            %% methods that require adjacency matrices
            [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_EigenAlign);
            ...
            [track_link_accuracy,MT,ML,frags,length_1_frags,frags_per_gt,mean_track_purity,mean_obj_purity] = quantify_accuracy_alltoone(base_track_gt, frame_track_gt, tracks_FAQAP);
